    ...
    <section className="mx-auto w-full max-w-5xl rounded-3xl border border-white/10 bg-slate-900/30 px-6 py-10 shadow-2xl backdrop-blur-md">
      <div className="flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="flex-shrink-0">
          ...
          >
            <div className="relative w-48 h-64 rounded-lg overflow-hidden border-2 border-amber-300/40 shadow-[0_10px_40px_rgba(0,0,0,0.4)] transition-all duration-500 hover:border-amber-300/70 hover:shadow-[0_15px_50px_rgba(251,191,36,0.3)] hover:scale-105">
              <img
